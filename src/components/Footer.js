  ...
  constructor() {
    ...
    <footer class="flex bg-[#AA0601]">
      ...
      >
        ...
        <div class="flex flex-col space-y-5 py-5 border-b-2 border-white pb-5">
          <div class="flex flex-row space-x-5">
            <img class="h-[48px]" src="/images/ic-footer-tel.svg" alt="tel" />
            <h1 class="text-4xl">0800-000-00</h1>
          </div>
          <div class="flex flex-row space-x-5">
            <img class="h-[48px]" src="/images/ic-footer-mail.svg" alt="tel" />
            <h1 class="text-4xl">glasses@business.com</h1>
          </div>
        </div>
        <div class="py-10">
          <p class="text-md">Copyright © 2020 Glasses.All rights reserved.</p>
        </div>
      </div>
    </footer>
    `;
